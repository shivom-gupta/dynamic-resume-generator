...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{ Technical Skills }
            \begin{sloppypar*}
                \cvtags{
                    \noindent Data Analysis/true, Data Visualization, BI Development/true, Statistical Analysis/true, EDA, Hypothesis Testing                }
                \cvtags{
                    \noindent SQL/true, Excel, Tableau/true, PowerBI/true                }
            \end{sloppypar*}
...
German Language/true                }
        ...
        \cvsection{ Profile }
        BI Analyst with proven expertise in SQL, Tableau, and PowerBI. Experienced in creating interactive dashboards, analyzing financial data, and delivering actionable insights to support business decisions. Consistently achieved high client satisfaction in freelance roles by improving data accuracy and providing clear, impactful visualizations.
