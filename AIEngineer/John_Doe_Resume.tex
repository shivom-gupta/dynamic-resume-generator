...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{ Technical Skills }
            \begin{sloppypar*}
                \cvtags{
                    \noindent Deep Learning/true, NLP/true, Computer Vision, Machine Learning/true, Data Preprocessing/true, Feature Engineering/true, CI CD, AI Agents/true                }
                \cvtags{
                    \noindent PyTorch/true, TensorFlow, Python/true, Git/true, Docker, AWS/true, Linux/true, C, C++                }
            \end{sloppypar*}
...
Problem Solving/true, Analytical Thinking/true, Team Collaboration/true, Communication/true                }
        ...
        \cvsection{ Currently Learning }
            \begin{sloppypar*}
                \cvtags{
Reinforcement Learning/true, AI Agents/true, German Language/true                }
            \end{sloppypar*}
        ...
        \cvsection{ Profile }
        AI Engineer specializing in the development and implementation of advanced AI systems, including deep learning models, NLP applications, and AI agents. Proficient in PyTorch, AWS, and modern architectures, with hands-on experience in building robust and scalable AI solutions. Combines a strong theoretical background with practical skills to solve complex engineering challenges.
        ...
        \cvevent
            ...
            { \cvreference{\faGithub}{ https://github.com/john-doe/image-classification } }
            {}
            {}
