...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{ Technical Skills }
            \begin{sloppypar*}
                \cvtags{
                    \noindent Deep Learning/true, NLP/true, Computer Vision, Machine Learning/true, Data Preprocessing/true, Feature Engineering/true, CI CD                }
                \cvtags{
...
Problem Solving/true, Analytical Thinking/true, Team Collaboration/true, Communication/true                }
        ...
        \cvsection{ Currently Learning }
            \begin{sloppypar*}
                \cvtags{
Reinforcement Learning/true, MLOps, German Language/true                }
            \end{sloppypar*}
        ...
        \cvsection{ Profile }
        Machine Learning Engineer with expertise in deep learning, NLP, and computer vision. Skilled in AI model development, cloud deployment, and data analysis. Brings a strong analytical approach from a computational science background to solve complex machine learning challenges.
